...
int main(int argc, char** argv) {
    ...
    std::cout << "foreground_ms=" << fg_ms << "\n"
              ...
              << "foreground_asr_prefill_candidate_tokens="
              << ctx->foreground_pipeline->last_asr_prefill_candidate_token_count() << "\n"
              << "foreground_asr_prefill_candidate_suffix_tokens="
              << ctx->foreground_pipeline->last_asr_prefill_candidate_suffix_token_count() << "\n"
              << "foreground_asr_prefill_skip_reason="
              << quote(ctx->foreground_pipeline->last_asr_prefill_skip_reason()) << "\n"
              ...
              << "foreground_final_prefix_path="
              << quote(foreground_metrics.final_prefix_path) << "\n"
              << "foreground_profile_final_prefix_path="
              << quote(foreground_metrics.final_prefix_path) << "\n"
              ...
              << foreground_metrics.tts_first_audio_priority_wait_deferred_count << "\n"
              << "foreground_profile_tts_first_audio_priority_following_text_bytes="
              << foreground_metrics.tts_first_audio_priority_following_text_bytes << "\n"
              << "foreground_profile_first_tts_chunk_reason="
              << quote(foreground_metrics.first_tts_chunk_reason) << "\n"
              << "foreground_profile_first_tts_chunk_pending_chars_at_first_content="
              << foreground_metrics.first_tts_chunk_pending_chars_at_first_content << "\n"
              << "foreground_profile_first_tts_chunk_pending_chars_at_enqueue="
              << foreground_metrics.first_tts_chunk_pending_chars_at_enqueue << "\n"
              << "foreground_profile_first_tts_chunk_wait_tokens="
              << foreground_metrics.first_tts_chunk_wait_tokens << "\n"
              << "foreground_profile_first_tts_chunk_wait_ms="
              << foreground_metrics.first_tts_chunk_wait_ms << "\n"
...

    {
        ...
        std::cout << "tts_callback_count=" << audio_capture.callback_count << "\n"
                  ...
                  << "tts_stream_session_enabled=" << tts_metrics.stream_session_enabled << "\n"
                  << "tts_session_text_appends=" << tts_metrics.session_text_appends << "\n"
                  << "tts_session_eos_suppressed=" << tts_metrics.session_eos_suppressed << "\n"
                  << "tts_session_resets=" << tts_metrics.session_resets << "\n"
                  ...
                  << tts_metrics.pause_silence_segments << "\n"
                  << "tts_pause_silence_ms="
                  << tts_metrics.pause_silence_ms << "\n"
                  << "tts_silence_lookahead_prefetch_enabled="
                  << tts_metrics.silence_lookahead_prefetch_enabled << "\n"
                  << "tts_silence_lookahead_prefetch_min_text_bytes="
                  << tts_metrics.silence_lookahead_prefetch_min_text_bytes << "\n"
                  << "tts_silence_lookahead_prefetch_attempts="
                  << tts_metrics.silence_lookahead_prefetch_attempts << "\n"
                  << "tts_silence_lookahead_prefetch_hits="
                  << tts_metrics.silence_lookahead_prefetch_hits << "\n"
                  << "tts_silence_lookahead_prefetch_tiny_skips="
                  << tts_metrics.silence_lookahead_prefetch_tiny_skips << "\n"
                  << "tts_silence_lookahead_prefetch_text_bytes="
                  << tts_metrics.silence_lookahead_prefetch_text_bytes << "\n"
                  << "tts_silence_lookahead_prefetch_audio_callbacks="
                  << tts_metrics.silence_lookahead_prefetch_audio_callbacks << "\n"
                  << "tts_silence_lookahead_prefetch_audio_samples="
                  << tts_metrics.silence_lookahead_prefetch_audio_samples << "\n"
                  << "tts_silence_lookahead_prefetch_backend_ms="
                  << tts_metrics.silence_lookahead_prefetch_backend_ms << "\n"
