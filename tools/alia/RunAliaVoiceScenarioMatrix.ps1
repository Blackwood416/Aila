...
try {
    ...
    foreach ($scenario in $scenarios) {
        ...
        $rows += [pscustomobject]@{
            ...
            tts_stream_session_enabled = Get-ValueOrEmpty $values "tts_stream_session_enabled"
            tts_session_text_appends = Get-ValueOrEmpty $values "tts_session_text_appends"
            tts_session_eos_suppressed = Get-ValueOrEmpty $values "tts_session_eos_suppressed"
            tts_session_resets = Get-ValueOrEmpty $values "tts_session_resets"
            ...
            tts_silence_lookahead_prefetch_enabled = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_enabled"
            tts_silence_lookahead_prefetch_min_text_bytes = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_min_text_bytes"
            tts_silence_lookahead_prefetch_attempts = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_attempts"
            tts_silence_lookahead_prefetch_hits = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_hits"
            tts_silence_lookahead_prefetch_tiny_skips = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_tiny_skips"
            tts_silence_lookahead_prefetch_text_bytes = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_text_bytes"
            tts_silence_lookahead_prefetch_audio_callbacks = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_audio_callbacks"
            tts_silence_lookahead_prefetch_audio_samples = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_audio_samples"
            tts_silence_lookahead_prefetch_backend_ms = Get-ValueOrEmpty $values "tts_silence_lookahead_prefetch_backend_ms"
